...
public class StorageImpl implements Storage
{
    ...
    public class CustomerSorter
    {
        ...
        {
            return customerMap.values().stream().sorted(Comparator.comparing(Customer::getLogin)).toList();
        }

        public List<Customer> sortCustomersByLoginReversed()
        {
            return customerMap.values().stream().sorted((o1, o2) -> o2.getLogin().compareTo(o1.getLogin())).toList();
        }

        public List<Customer> sortCustomersByPassword()
        {
            return customerMap.values().stream().sorted(Comparator.comparing(Customer::getPassword)).toList();
        }

        public List<Customer> sortCustomersByPasswordReversed()
        {
            return customerMap.values().stream().sorted((o1, o2) -> o2.getPassword().compareTo(o1.getPassword())).toList();
        }

        public List<Customer> sortCustomersByBalance()
        {
            return customerMap.values().stream().sorted((o1, o2) ->
                                                        {
        ...
        {
            return customerMap.values().stream().sorted(Comparator.comparing(Customer::getName)).toList();
        }

        public List<Customer> sortCustomersByNameReversed()
        {
            return customerMap.values().stream().sorted((o1, o2) -> o2.getName().compareTo(o1.getName())).toList();
        }

        public List<Customer> sortCustomersByID()
        {
            return customerMap.values().stream().sorted(Comparator.comparingInt(Customer::getID)).toList();
        }

        public List<Customer> sortCustomersByIDReversed()
        {
            return customerMap.values().stream().sorted((o1, o2) -> o2.getID() - o1.getID()).toList();
        }
    }
    ...
    public class OrderSorter
    {
        ...
        {
            return orderMap.values().stream().sorted((o1, o2) -> o2.getAdmin().getLogin().compareTo(o1.getAdmin().getLogin())).toList();
        }
        ...
        {
            return orderMap.values().stream().sorted((o1, o2) -> o2.getService().getName().compareTo(o1.getService().getName())).toList();
        }
    ...
    public class ServiceSorter
    {
        ...
        {
            return serviceMap.values().stream().sorted((o1, o2) -> o2.getDescription().compareTo(o1.getDescription())).toList();
        }
        ...
        {
            return serviceMap.values().stream().sorted(Comparator.comparing(o -> o.getTemplate().getName())).toList();
        }

        public List<Service> sortServicesByTemplateNameReversed()
        {
            return serviceMap.values().stream().sorted((o1, o2) -> o2.getTemplate().getName().compareTo(o1.getTemplate().getName())).toList();
        }

        public List<Service> sortServicesByCustomerLogin()
        {
            return serviceMap.values().stream().sorted(Comparator.comparing(o -> o.getCustomer().getLogin())).toList();
        }

        public List<Service> sortServicesByCustomerLoginReversed()
        {
            return serviceMap.values().stream().sorted((o1, o2) -> o2.getCustomer().getLogin().compareTo(o1.getCustomer().getLogin())).toList();
        }
        ...
        {
            return serviceMap.values().stream().sorted((o1, o2) -> o2.getStatus().compareTo(o1.getStatus())).toList();
        }
    }
    ...
    public class AdminSorter
    {
        ...
        {
            return adminMap.values().stream().sorted((o1, o2) -> o2.getPassword().compareTo(o1.getPassword())).toList();
        }
    ...
    public class AreaSorter
    {
        ...
        {
            return areaMap.values().stream().sorted((o1, o2) -> o2.getDescription().compareTo(o1.getDescription())).toList();
        }
    }
    ...
    public class TemplateSorter
    {
        ...
        {
            return templateMap.values().stream().sorted((o1, o2) -> o2.getDescription().compareTo(o1.getDescription())).toList();
        }
        ...
        {
            return templateMap.values().stream().sorted((o1, o2) -> o2.getArea().getName().compareTo(o1.getArea().getName())).toList();
        }
    }
